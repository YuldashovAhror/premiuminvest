<header id="page-topbar">
  <div class="navbar-header d-flex flex-row-reverse">
{{--    <div class="d-flex">--}}
...
{{--      </div>--}}
      <div class="dropdown d-inline-block">
        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
          ...
          <div>
            <span class="d-none mt-2 d-xl-inline-block ms-1 fw-medium font-size-20">{{auth()->user()->name}}</span>
        ...
        <div class="dropdown-menu dropdown-menu-end">
          ...
          <form method="POST" action="{{ route('logout') }}" x-data>
            ...
            <a class="dropdown-item" href="{{ route('logout') }}" @click.prevent="$root.submit();"><i
                ...
                class="align-middle">{{__('выход')}}</span></a>
          </form>
        </div>
      </div>
    </div>
